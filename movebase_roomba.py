...
rospy.init_node("movebase_roomba")
...
def check_camera():
	...
	set_transform("map","roomba",trans,quaternion)

def initialize():
	check_camera()
	(trans,rot) = get_transform("map","roomba")
